...
void GameStateManager::Initialize()
{
	...
	gameStates[GameStateType::STATE_FVF] = nullptr;
	gameStates[GameStateType::STATE_TEXTURE] = nullptr;
	gameStates[GameStateType::STATE_HIERARCHY_ANIMATION] = nullptr;
	...
	currentState = GameStateType::STATE_DIRECT_X_BASE;
